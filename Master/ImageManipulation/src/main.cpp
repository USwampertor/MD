...
void drawTopTriangle(Triangle t, Texture& tex, Image& img, const PixelShader& pShader) {
  Vertex p0 = t.v0;
  Vertex p1 = t.v1; 
  Vertex p2 = t.v2;
...
void drawBottomTriangle(Triangle t, Texture& tex, Image& img, const PixelShader& pShader) {
  Vertex p0 = t.v0;
  Vertex p1 = t.v1;
  Vertex p2 = t.v2;
...
void
fillTriangle(const Triangle& t, Texture& tex, Image& img, const Color& toColor, const PixelShader& pShader) {
...
//   destinyFile.clear(Color::BLACK);
  ...
  PixelShader uvPShader = [&horseTexture](float u, float v) {
    Color c(u, v, 0.0f, 1.0f); 
    return c;
  };

  PixelShader texPShader = [&horseTexture](float u, float v) {
    Color c/*(u, v, 0.0f, 1.0f);*/ = horseTexture.sample(u, v, eTextureMode::CLAMP, eSamplerFilter::LINEAR);
    return c;
  };

  PixelShader greyPShader = [&horseTexture](float u, float v) {
  ...
  PixelShader kernelPShader = [&horseTexture](float u, float v) {
  ...
  PixelShader normalPShader = [&horseTexture](float u, float v) {
